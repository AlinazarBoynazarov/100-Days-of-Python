...
def report():
    """function displaying the current status of machine's resources"""
    status = {
        "Water": 1000,
        "Milk": 600,
        "Coffee": 400,
...
def reqs():
    """function displaying resource requirements of each drink"""
    latte = {
        "Water": 200,
        "Milk": 300,
        "Coffee": 200
...
def check_resources(answer, lat, espr, cappuc, stat):
    """function checking resource requirements of drinks against the current resources machine has"""
    lacking_resources = []
    coffe_to_be_made = {}
...
def cost():
    """function for monetary cost of each drink"""
    cost_dict = {
...
def coins():
    """function calculating amount of quarters, dimes, nickles and pennies into a value"""
